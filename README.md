...
TO accomplish the task, I harvested and combined data (MTA turnstile, Station Geocodes, Property Values, GeoJSONs, Inflation Adjuster) from a variety of sources (e.g., [web scraped urls, wget for page content](http://web.mta.info/developers/turnstile.html), (Github repositories)[https://github.com/chriswhong/nycturnstiles], (extracted data from D3 viz)[http://youarehere.cc/#/maps/by-city/new_york], (OpenNYC)[https://nycopendata.socrata.com/]). [All original data uploaded in respective folders].
